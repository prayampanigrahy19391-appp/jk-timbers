...
assert.equal(rateLimit(request, 2, 60_000, 'auth-test').success, true);
assert.equal(rateLimit(request, 2, 60_000, 'auth-test').success, true);
assert.equal(rateLimit(request, 2, 60_000, 'auth-test').success, false);
assert.equal(rateLimit(request, 2, 60_000, 'cart-test').success, true);
