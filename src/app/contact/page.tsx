            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" className="w-full p-3 rounded-xl border border-wood-200 dark:border-timber-700 bg-wood-50 dark:bg-timber-950 focus:ring-2 focus:ring-accent outline-none text-wood-950 dark:text-white" />
                </div>
                <div>
              ...
              <div>
                ...
                <input type="tel" className="w-full p-3 rounded-xl border border-wood-200 dark:border-timber-700 bg-wood-50 dark:bg-timber-950 focus:ring-2 focus:ring-accent outline-none text-wood-950 dark:text-white" />
              </div>

              <div>
                <label className="block text-sm font-medium text-timber-700 dark:text-timber-300 mb-2">Message</label>
                <textarea rows={4} className="w-full p-3 rounded-xl border border-wood-200 dark:border-timber-700 bg-wood-50 dark:bg-timber-950 focus:ring-2 focus:ring-accent outline-none resize-none text-wood-950 dark:text-white" placeholder="Tell us about your requirements..."></textarea>
              </div>

              <button className="w-full bg-wood-950 hover:bg-wood-800 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-timber-900 rounded-2xl border border-wood-100 dark:border-timber-800 overflow-hidden shadow-sm">
              <div className="h-64 relative w-full">
                {/* Google Maps Embed for Berhampur New Bus Stand */}
                <iframe 
